...
def make_fig():
    ...
    ax2.plot([punti1[1],punti2[1],punti3[1]], [punti1[0], punti2[0], punti3[0]], 'b', linewidth=3)
    ax2.plot([punti4[1], punti5[1],punti6[1],punti7[1], punti8[1]], [punti4[0], punti5[0], punti6[0], punti7[0], punti8[0]], 'b', linewidth=3)
    ax2.plot([punti9[1],punti10[1]], [punti9[0], punti10[0]], 'b', linewidth=3)
