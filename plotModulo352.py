...
def make_fig():
    ...
    pylab.plot([yM1,yM2,yM3], [xM1, xM2, xM3], 'b', linewidth=3)
    pylab.plot([yM4, yM11,yM22,yM33, yM111], [xM4, xM11, xM22, xM33, xM111], 'b', linewidth=3)
    pylab.plot([yM222,yM333], [xM222, xM333], 'b', linewidth=3)
    #ax1.set_xlim(0, 740)
    #ax1.set_ylim(515, 0)
